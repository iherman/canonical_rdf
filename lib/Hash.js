"use strict"
/**
 * Hashing related functions needed by the Hogan algorithm for canonicalization.
 */
...
class HashValue {
    ...
    /**
     * Get access to the buffer. In fact, this is only used by the function in this module, is not really necessary to have
     * it in general...
     * (I am not sure whether it is possible to restrict the visibility of this function to the module in Javascript...)
     */
    get value() {
        return this._value;
    }
 ...
 */
// function hashTerm(data = NULL) {
//     return new HashValue(crypto.createHash(SHA).update(data).digest());
// }
